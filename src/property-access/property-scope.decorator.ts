 ...
 * property / unit / tenant / landlord / contract. `PropertyAccessGuard` reads this
 * metadata and enforces that the current user is entitled to that resource,
